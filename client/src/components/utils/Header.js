...
export default function Header() {
  ...
  return (
    <header className="sticky-xl-top">
      <nav className="navbar navbar-expand-lg p-1 navbar-light bg-light sticky-top d-flex flex-row justify-content-around  ">
        <div className="container">
          <ToggleBtnSmallScreen />
          <NavLink className="me-0 me-lg-2 navbar-brand my-brand" to="/">HCMUT's Printing Service</NavLink>
          { user.token !== null ?
...
function NavbarMenu({ pageLinks }) {
  return (
    <ul className="navbar-nav fw-semibold fs-5 upper text-lg-center me-auto justify-content-around d-flex">
